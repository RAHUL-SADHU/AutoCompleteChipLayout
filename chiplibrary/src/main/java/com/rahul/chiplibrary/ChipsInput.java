...
import com.rahul.chiplibrary.adapter.ChipsAdapter;
import com.rahul.chiplibrary.model.Chip;
import com.rahul.chiplibrary.model.ChipInterface;
import com.rahul.chiplibrary.util.ActivityUtil;
import com.rahul.chiplibrary.util.MyWindowCallback;
import com.rahul.chiplibrary.util.ViewUtil;
import com.rahul.chiplibrary.views.ChipsInputEditText;
import com.rahul.chiplibrary.views.DetailedChipView;
import com.rahul.chiplibrary.views.FilterableListView;
import com.rahul.chiplibrary.views.ScrollViewMaxHeight;
...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private boolean mChipEdittextEnable = true;
    ...
    private void init(AttributeSet attrs) {
        ...
        // butter knife
        mRecyclerView = rootView.findViewById(R.id.chips_recycler_view);
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mChipEdittextEnable = a.getBoolean(R.styleable.ChipsInput_chip_edit_enable, true);
            } finally {
                a.recycle();
            }
        }
    ...
    public ChipsInputEditText getEditText() {
        ...
        Typeface type = Typeface.createFromAsset(getContext().getAssets(), "sf_ui_text_light.otf");
